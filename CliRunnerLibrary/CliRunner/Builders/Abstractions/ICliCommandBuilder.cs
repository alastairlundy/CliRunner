...
public interface ICliCommandBuilder
{
    ...
    ICliCommandBuilder WithArguments(IEnumerable<string> arguments);
    ...
    ICliCommandBuilder WithArguments(IEnumerable<string> arguments, bool escapeArguments);
    ...
    /// <param name="arguments">The arguments to pass to the executable.</param>
    /// <returns>The new ICommandBuilder object with the specified arguments.</returns>
    ICliCommandBuilder WithArguments(string arguments);
    ...
    ICliCommandBuilder WithTargetFile(string targetFilePath);
    ...
    ICliCommandBuilder WithEnvironmentVariables(IReadOnlyDictionary<string, string> environmentVariables);
    ...
    /// <returns>The new CommandBuilder with the specified environment variables.</returns>
    ICliCommandBuilder WithEnvironmentVariables(Action<IEnvironmentVariablesBuilder> configure);
    ...
    ICliCommandBuilder WithAdministratorPrivileges(bool runAsAdministrator);
    ...
    ICliCommandBuilder WithWorkingDirectory(string workingDirectoryPath);
    ...
    ICliCommandBuilder WithUserCredential(UserCredential credentials);
    ...
    /// <returns>The new CommandBuilder with the specified Credentials.</returns>
    ICliCommandBuilder WithUserCredential(Action<IUserCredentialBuilder> configure);
    ...
    ICliCommandBuilder WithValidation(ProcessResultValidation validation);
    ...
    ICliCommandBuilder WithStandardInputPipe(StreamWriter source);
    ...
    ICliCommandBuilder WithStandardOutputPipe(StreamReader target);
    ...
    ICliCommandBuilder WithStandardErrorPipe(StreamReader target);
    ...
    ICliCommandBuilder WithProcessResourcePolicy(ProcessResourcePolicy processResourcePolicy);
    ...
    ICliCommandBuilder WithShellExecution(bool useShellExecution);
    ...
    ICliCommandBuilder WithWindowCreation(bool enableWindowCreation);
    ...
    ICliCommandBuilder WithEncoding(Encoding standardInputEncoding = null,
